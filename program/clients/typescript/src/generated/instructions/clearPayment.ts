...
export function getClearPaymentInstructionDataEncoder(): FixedSizeEncoder<ClearPaymentInstructionDataArgs> {
  return transformEncoder(getStructEncoder([['discriminator', getU8Encoder()]]), (value) => ({ ...value, discriminator: CLEAR_PAYMENT_DISCRIMINATOR }));
}
...
export function getClearPaymentInstructionDataCodec(): FixedSizeCodec<ClearPaymentInstructionDataArgs, ClearPaymentInstructionData> {
  return combineCodec(getClearPaymentInstructionDataEncoder(), getClearPaymentInstructionDataDecoder());
}



export type ClearPaymentAsyncInput<TAccountPayer extends string = string,
...
export async function getClearPaymentInstructionAsync<TAccountPayer extends string, TAccountPayment extends string, TAccountOperatorAuthority extends string, TAccountBuyer extends string, TAccountMerchant extends string, TAccountOperator extends string, TAccountMerchantOperatorConfig extends string, TAccountMint extends string, TAccountMerchantEscrowAta extends string, TAccountMerchantSettlementAta extends string, TAccountOperatorSettlementAta extends string, TAccountTokenProgram extends string, TAccountAssociatedTokenProgram extends string, TAccountSystemProgram extends string, TAccountEventAuthority extends string, TAccountCommerceProgram extends string, TProgramAddress extends Address = typeof COMMERCE_PROGRAM_PROGRAM_ADDRESS>(input: ClearPaymentAsyncInput<TAccountPayer, TAccountPayment, TAccountOperatorAuthority, TAccountBuyer, TAccountMerchant, TAccountOperator, TAccountMerchantOperatorConfig, TAccountMint, TAccountMerchantEscrowAta, TAccountMerchantSettlementAta, TAccountOperatorSettlementAta, TAccountTokenProgram, TAccountAssociatedTokenProgram, TAccountSystemProgram, TAccountEventAuthority, TAccountCommerceProgram>, config?: { programAddress?: TProgramAddress } ): Promise<ClearPaymentInstruction<TProgramAddress, TAccountPayer, TAccountPayment, TAccountOperatorAuthority, TAccountBuyer, TAccountMerchant, TAccountOperator, TAccountMerchantOperatorConfig, TAccountMint, TAccountMerchantEscrowAta, TAccountMerchantSettlementAta, TAccountOperatorSettlementAta, TAccountTokenProgram, TAccountAssociatedTokenProgram, TAccountSystemProgram, TAccountEventAuthority, TAccountCommerceProgram>> {
  ...
  const programAddress = config?.programAddress ?? COMMERCE_PROGRAM_PROGRAM_ADDRESS;
    ...
    const originalAccounts = {
              ...
              operatorSettlementAta: { value: input.operatorSettlementAta ?? null, isWritable: true },
...
accounts.operatorSettlementAta.value = await getProgramDerivedAddress({ programAddress: 'ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL' as Address<'ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL'>, seeds: [getAddressEncoder().encode(expectAddress(accounts.operatorAuthority.value)), getAddressEncoder().encode(address("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA")), getAddressEncoder().encode(expectAddress(accounts.mint.value))] });
}
...
accounts.commerceProgram.value = 'commkU28d52cwo2Ma3Marxz4Qr9REtfJtuUfqnDnbhT' as Address<'commkU28d52cwo2Ma3Marxz4Qr9REtfJtuUfqnDnbhT'>;
    ...
    const instruction = {accounts: [
      ...
      } as ClearPaymentInstruction<TProgramAddress, TAccountPayer, TAccountPayment, TAccountOperatorAuthority, TAccountBuyer, TAccountMerchant, TAccountOperator, TAccountMerchantOperatorConfig, TAccountMint, TAccountMerchantEscrowAta, TAccountMerchantSettlementAta, TAccountOperatorSettlementAta, TAccountTokenProgram, TAccountAssociatedTokenProgram, TAccountSystemProgram, TAccountEventAuthority, TAccountCommerceProgram>;

      return instruction;
  }


export type ClearPaymentInput<TAccountPayer extends string = string,
  TAccountPayment extends string = string,
  TAccountOperatorAuthority extends string = string,
  TAccountBuyer extends string = string,
  TAccountMerchant extends string = string,
