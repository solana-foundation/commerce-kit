...
export function getRefundPaymentDiscriminatorBytes() { return getU8Encoder().encode(REFUND_PAYMENT_DISCRIMINATOR); }
...
export function getRefundPaymentInstructionDataEncoder(): FixedSizeEncoder<RefundPaymentInstructionDataArgs> {
  return transformEncoder(getStructEncoder([['discriminator', getU8Encoder()]]), (value) => ({ ...value, discriminator: REFUND_PAYMENT_DISCRIMINATOR }));
}
...
export function getRefundPaymentInstructionDataCodec(): FixedSizeCodec<RefundPaymentInstructionDataArgs, RefundPaymentInstructionData> {
  return combineCodec(getRefundPaymentInstructionDataEncoder(), getRefundPaymentInstructionDataDecoder());
}



export type RefundPaymentAsyncInput<TAccountPayer extends string = string,
...
export type RefundPaymentInput<TAccountPayer extends string = string,
  TAccountPayment extends string = string,
  TAccountOperatorAuthority extends string = string,
  TAccountBuyer extends string = string,
  TAccountMerchant extends string = string,
