...
import { address, combineCodec, getAddressEncoder, getProgramDerivedAddress, getStructDecoder, getStructEncoder, getU32Decoder, getU32Encoder, getU64Decoder, getU64Encoder, getU8Decoder, getU8Encoder, getUtf8Encoder, transformEncoder, type AccountMeta, type AccountSignerMeta, type Address, type FixedSizeCodec, type FixedSizeDecoder, type FixedSizeEncoder, type Instruction, type InstructionWithAccounts, type InstructionWithData, type ReadonlyAccount, type ReadonlySignerAccount, type ReadonlyUint8Array, type TransactionSigner, type WritableAccount, type WritableSignerAccount } from '@solana/kit';
...
/** Commerce Program ID */
commerceProgram?: Address<TAccountCommerceProgram>;orderId: MakePaymentInstructionDataArgs["orderId"];
...
export async function getMakePaymentInstructionAsync<TAccountPayer extends string, TAccountPayment extends string, TAccountOperatorAuthority extends string, TAccountBuyer extends string, TAccountOperator extends string, TAccountMerchant extends string, TAccountMerchantOperatorConfig extends string, TAccountMint extends string, TAccountBuyerAta extends string, TAccountMerchantEscrowAta extends string, TAccountMerchantSettlementAta extends string, TAccountTokenProgram extends string, TAccountSystemProgram extends string, TAccountEventAuthority extends string, TAccountCommerceProgram extends string, TProgramAddress extends Address = typeof COMMERCE_PROGRAM_PROGRAM_ADDRESS>(input: MakePaymentAsyncInput<TAccountPayer, TAccountPayment, TAccountOperatorAuthority, TAccountBuyer, TAccountOperator, TAccountMerchant, TAccountMerchantOperatorConfig, TAccountMint, TAccountBuyerAta, TAccountMerchantEscrowAta, TAccountMerchantSettlementAta, TAccountTokenProgram, TAccountSystemProgram, TAccountEventAuthority, TAccountCommerceProgram>, config?: { programAddress?: TProgramAddress } ): Promise<MakePaymentInstruction<TProgramAddress, TAccountPayer, TAccountPayment, TAccountOperatorAuthority, TAccountBuyer, TAccountOperator, TAccountMerchant, TAccountMerchantOperatorConfig, TAccountMint, TAccountBuyerAta, TAccountMerchantEscrowAta, TAccountMerchantSettlementAta, TAccountTokenProgram, TAccountSystemProgram, TAccountEventAuthority, TAccountCommerceProgram>> {
  ...
  const programAddress = config?.programAddress ?? COMMERCE_PROGRAM_PROGRAM_ADDRESS;
    ...
    const originalAccounts = {
              ...
              merchantOperatorConfig: { value: input.merchantOperatorConfig ?? null, isWritable: true },
              ...
              merchantSettlementAta: { value: input.merchantSettlementAta ?? null, isWritable: true },
...
accounts.payment.value = await getProgramDerivedAddress({ programAddress: 'commkU28d52cwo2Ma3Marxz4Qr9REtfJtuUfqnDnbhT' as Address<'commkU28d52cwo2Ma3Marxz4Qr9REtfJtuUfqnDnbhT'>, seeds: [getUtf8Encoder().encode("payment"), getAddressEncoder().encode(expectAddress(accounts.merchantOperatorConfig.value)), getAddressEncoder().encode(expectAddress(accounts.buyer.value)), getAddressEncoder().encode(expectAddress(accounts.mint.value)), getU32Encoder().encode(expectSome(args.orderId))] });
}
...
accounts.commerceProgram.value = 'commkU28d52cwo2Ma3Marxz4Qr9REtfJtuUfqnDnbhT' as Address<'commkU28d52cwo2Ma3Marxz4Qr9REtfJtuUfqnDnbhT'>;
    ...
    const instruction = {accounts: [
          ...
          data: getMakePaymentInstructionDataEncoder().encode(args as MakePaymentInstructionDataArgs),
...
export type MakePaymentInput<TAccountPayer extends string = string,
  TAccountPayment extends string = string,
  TAccountOperatorAuthority extends string = string,
  TAccountBuyer extends string = string,
  TAccountOperator extends string = string,
