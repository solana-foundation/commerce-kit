...
export function getCreateOperatorDiscriminatorBytes() { return getU8Encoder().encode(CREATE_OPERATOR_DISCRIMINATOR); }

export type CreateOperatorInstruction<
  TProgram extends string = typeof COMMERCE_PROGRAM_PROGRAM_ADDRESS,
      TAccountPayer extends string | AccountMeta<string> = string, TAccountOperator extends string | AccountMeta<string> = string, TAccountAuthority extends string | AccountMeta<string> = string, TAccountSystemProgram extends string | AccountMeta<string> = "11111111111111111111111111111111",
    TRemainingAccounts extends readonly AccountMeta<string>[] = [],
> = Instruction<TProgram>
      & InstructionWithData<ReadonlyUint8Array>
        & InstructionWithAccounts<[TAccountPayer extends string ? WritableSignerAccount<TAccountPayer> & AccountSignerMeta<TAccountPayer> : TAccountPayer, TAccountOperator extends string ? WritableAccount<TAccountOperator> : TAccountOperator, TAccountAuthority extends string ? ReadonlySignerAccount<TAccountAuthority> & AccountSignerMeta<TAccountAuthority> : TAccountAuthority, TAccountSystemProgram extends string ? ReadonlyAccount<TAccountSystemProgram> : TAccountSystemProgram, ...TRemainingAccounts]>
  ;



export type CreateOperatorInstructionData = { discriminator: number; bump: number;  };
...
export function getCreateOperatorInstructionDataEncoder(): FixedSizeEncoder<CreateOperatorInstructionDataArgs> {
  return transformEncoder(getStructEncoder([['discriminator', getU8Encoder()], ['bump', getU8Encoder()]]), (value) => ({ ...value, discriminator: CREATE_OPERATOR_DISCRIMINATOR }));
}
...
export function getCreateOperatorInstructionDataCodec(): FixedSizeCodec<CreateOperatorInstructionDataArgs, CreateOperatorInstructionData> {
  return combineCodec(getCreateOperatorInstructionDataEncoder(), getCreateOperatorInstructionDataDecoder());
}



export type CreateOperatorAsyncInput<TAccountPayer extends string = string,
...
accounts.systemProgram.value = '11111111111111111111111111111111' as Address<'11111111111111111111111111111111'>;
    ...
    const instruction = {accounts: [
          ...
          data: getCreateOperatorInstructionDataEncoder().encode(args as CreateOperatorInstructionDataArgs),
      } as CreateOperatorInstruction<TProgramAddress, TAccountPayer, TAccountOperator, TAccountAuthority, TAccountSystemProgram>;

      return instruction;
  }


export type CreateOperatorInput<TAccountPayer extends string = string,
  TAccountOperator extends string = string,
  TAccountAuthority extends string = string,
  TAccountSystemProgram extends string = string,
  >
