...
describe('Status', () => {
  ...
  it('should serialize status values correctly', () => {
    ...
    expect(encoder.encode(Status.Refunded)).toEqual(new Uint8Array([2]));
  });
  ...
  it('should deserialize status values correctly', () => {
    ...
    expect(decoder.decode(new Uint8Array([2]))).toBe(Status.Refunded);
  });
