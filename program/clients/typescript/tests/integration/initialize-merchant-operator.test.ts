...
import { assertGetOrCreateOperator, assertGetOrCreateMerchant, assertGetOrCreateMerchantOperatorConfig } from './helpers/state-utils';
...
describe('Initialize Merchant Operator Config', () => {
    ...
    beforeEach(async () => {
        ...
        await setupWallets(client, [payer, operatorAuthority, merchantAuthority, settlementWallet]);
