...
// Commerce Program Error Codes
pub const INVALID_MINT_ERROR: u32 = 0;
pub const INVALID_PAYMENT_STATUS_ERROR: u32 = 1;
pub const INSUFFICIENT_SETTLEMENT_AMOUNT_ERROR: u32 = 2;
