...
const TEST_ADDRESSES = {
    PHANTOM_ACCOUNT_1: TEST_ADDRESSES.PHANTOM_ACCOUNT_1,
    PHANTOM_ACCOUNT_2: TEST_ADDRESSES.PHANTOM_ACCOUNT_2,
    PHANTOM_ACCOUNT_3: TEST_ADDRESSES.PHANTOM_ACCOUNT_3,
    PHANTOM_ACCOUNT_4: TEST_ADDRESSES.PHANTOM_ACCOUNT_4,
    NONEXISTENT_ACCOUNT: TEST_ADDRESSES.NONEXISTENT_ACCOUNT,
} as const;
