...
export const ConnectButton = memo<ConnectButtonProps>(
    ({ className, style, variant = 'default', theme = {}, label }) => {
                ...
                <DropdownRoot open={dropdownOpen} onOpenChange={setDropdownOpen}>
                    <DropdownTrigger asChild>
                        <button
                            ...
                            onMouseLeave={e => {
                                setIsHovered(false);
                                setIsPressed(false);
                                e.currentTarget.style.boxShadow = getButtonShadow(t.buttonShadow);
                            }}
                            onMouseDown={() => setIsPressed(true)}
                            onMouseUp={() => setIsPressed(false)}
                            onFocus={e => {
                                setIsHovered(true);
                                e.currentTarget.style.boxShadow = `${getButtonShadow(t.buttonShadow)}, 0 0 0 4px rgba(202, 202, 202, 0.45)`;
                            }}
                            onBlur={e => {
                                setIsHovered(false);
                                e.currentTarget.style.boxShadow = getButtonShadow(t.buttonShadow);
                    ...
                    <DropdownContent align="end">
                        ...
                        >
                            ...
                            <div
                                style={{ padding: '8px 12px', fontSize: 13, fontFamily: 'monospace', color: '#111827' }}
                            >
                                {selectedDisplay}
                            </div>
                            {accounts.length > 1 ? (
                        ...
                        {currentStep === 'help' ? (
                            ...
                            <>
                                ...
                                <div style={{ marginBottom: 16, fontSize: 12, color: '#6b7280' }}>
                                    Select one of your available wallets.
                                </div>
                                        ...
                                        {connectableWallets.length > 0 ? (
                                            <div
                                                style={{
                                                    ...
                                                    gap: 8,
                                                    marginBottom: unconnectableWallets.length ? 12 : 0,
                                                }}
                                            >
                                                {connectableWallets.map((w: any) => (
                                                    <button
                                                        ...
                                                        style={{
                                                            ...
                                                            opacity:
                                                                connecting && connectingWalletName !== w.name ? 0.7 : 1,
                                                            transition:
                                            ...
                                            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                                                {unconnectableWallets.map((w: any) => (
                                                    ...
                                                    >
                                                        ...
                                                        <span aria-hidden style={{ fontSize: 12, color: '#f59e0b' }}>
                                                            !
                                                        </span>
                                                    </button>
                                                ))}
