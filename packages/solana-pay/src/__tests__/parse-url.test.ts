...
describe('parseURL', () => {
  ...
  describe('Reference Parsing', () => {
    it('should parse single reference', () => {
      const url = 'solana:9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM?reference=4fYNw3dojWmQ2dXuYHdhTWgJyg7BLZZeEfH5TjxH6nKK'
      const result = parseURL(url)
      expect(result.reference).toHaveLength(1)
    })

    it('should parse multiple references', () => {
      const url = 'solana:9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM?reference=4fYNw3dojWmQ2dXuYHdhTWgJyg7BLZZeEfH5TjxH6nKK&reference=2Azp9LdtCbxZ9Z7YyxPKLfVpK1TRfqe6QzHnNhCJkNJB'
      const result = parseURL(url)
  ...
  describe('URL Variations', () => {
    ...
    it('should handle encoded special characters', () => {
      const url = 'solana:9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM?label=Test%20%26%20Payment&message=Hello%20World%21'
      const result = parseURL(url)
      expect(result.label).toBe('Test & Payment')
    ...
    it('should preserve whitespace in labels and messages', () => {
      const url = 'solana:9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM?label=Multi%20word%20label&message=Multi%20word%20message'
      const result = parseURL(url)
