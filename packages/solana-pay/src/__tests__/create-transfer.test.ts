...
describe('createTransfer', () => {
  ...
  describe('Account Validation', () => {
    it('should throw error when sender account not found', async () => {
      ...
      await expect(createTransfer(localMockRpc as any, testSender, fields))
  ...
  describe('Transaction Building', () => {
    it('should use functional pipe pattern', async () => {
      ...
      const { pipe, createTransactionMessage, setTransactionMessageLifetimeUsingBlockhash, appendTransactionMessageInstructions } = await import('gill')
  ...
  describe('Error Handling', () => {
    it('should handle RPC errors gracefully', async () => {
      ...
      await expect(createTransfer(mockRpc as any, testSender, fields))
    ...
    it('should handle instruction creation errors', async () => {
      ...
      await expect(createTransfer(mockRpc as any, testSender, fields))
        .rejects.toThrow('Instruction creation failed')
    })
  })
  ...
  describe('Performance', () => {
    it('should handle multiple concurrent transfer creations', async () => {
      ...
      const promises = fields.map(field => 
        createTransfer(mockRpc as any, testSender, field)
      )
