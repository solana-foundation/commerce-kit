...
export function TransactionError({
  ...
  return (
    <div className="ck-transaction-error ck-transaction-error-container" style={{ backgroundColor: theme.backgroundColor, color: theme.textColor }}>
      {/* Error Icon */}
