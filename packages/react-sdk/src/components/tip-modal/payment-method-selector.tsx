...
export const PaymentMethodSelector = memo<PaymentMethodSelectorProps>(({ theme, selectedPaymentMethod, onSelect }) => {
    return (
        <div
...
const PaymentMethodButton = memo<PaymentMethodButtonProps>(({ theme, method, isSelected, onClick }) => {
    ...
    return (
        ...
        >
            <div className="ck-payment-method-header">
                <span className="ck-payment-method-icon">{method.icon}</span>
                <span className="ck-payment-method-label">{method.label}</span>
            </div>
            <div className="ck-payment-method-description">{method.description}</div>
        </button>
    );
});
