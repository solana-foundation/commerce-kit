...
describe('Transaction State Components', () => {
  describe('TransactionError', () => {
    ...
    it('should handle long error messages', () => {
      const longError = 'This is a very long error message that might wrap to multiple lines and should be handled gracefully by the component without breaking the layout or causing overflow issues'
  ...
  describe('Signature formatting', () => {
    it('should format long signatures correctly', () => {
      const longSignature = '5VfYmGC9L2VTqCdqRCKt7LcaUp5XYRhZzpq3r1YqDbhqKjDdKBEWQGKfMtpJJwz7CKt8Q4r2VcDZF1QCqRcSGQjU'
